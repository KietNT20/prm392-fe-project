...
import { useGetAllNews, useDeleteNew } from '@/hooks/New'; 
...
const NewListingScreen = ({ navigation }) => {
  ...
  const { news: searchResults, isLoading: isSearching, isError: isSearchError } = useQueryNew(searchTerm);
          ...
          <TouchableWithoutFeedback onPress={() => setModalVisible(false)}>
            ...
            >
              <View className="bg-white p-6 rounded-lg w-4/5">
                <TouchableOpacity onPress={() => handleDetail(selectedNews._id)} className="my-2">
        ...
        <TouchableWithoutFeedback onPress={() => setSearchModalVisible(false)}>
          ...
          >
            <View className="bg-white p-6 rounded-lg w-4/5">
              ...
              />
              <TouchableOpacity onPress={() => setSearchTerm('')} className="bg-blue-500 p-2 rounded">
                <Text className="text-white text-center">Search</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setSearchModalVisible(false)} className="mt-4">
